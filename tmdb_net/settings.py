"""
Django settings for tmdb_net project.
...
SECRET_KEY = os.environ.get('SECRET_KEY', 'django-insecure-g6sl8ol8wab$e@(do3!()ry#s3st-qon6qm#llb7018x5ea81m')

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = os.environ.get('DEBUG', 'True') == 'True'

ALLOWED_HOSTS = os.environ.get('ALLOWED_HOSTS', 'localhost,127.0.0.1,kino-bro.ru,www.kino-bro.ru').split(',')
...
WSGI_APPLICATION = 'tmdb_net.wsgi.application'
...
DEFAULT_FROM_EMAIL = os.environ.get('DEFAULT_FROM_EMAIL', 'noreply@kino-bro.ru')
